...
- "observaciones": arreglo de 2 a 5 notas importantes de cierre, cada una con su referencia. NO repitas aquí un requisito o dato que ya esté en "requisitosClave", "checklist" o "informacionGeneral"; reserva esta clave para riesgos, condiciones especiales o aclaraciones que no encajen en las otras secciones.
- Concisión y no repetición (regla transversal del resumen): cada dato debe aparecer UNA SOLA VEZ en todo el resumen. No repitas el mismo equipo, garantía, plazo, requisito u obligación en varias secciones; si algo ya quedó en su sección natural, no lo vuelvas a listar en otra (el checklist solo puede reformular un requisito como acción verificable, no repetirlo textual). Redacta cada punto de forma directa, sin relleno ni frases genéricas de cortesía: que no falte ningún dato relevante, pero que tampoco sobre texto. Prefiere una línea corta y precisa antes que un párrafo redundante.
