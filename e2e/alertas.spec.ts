...
// Nota: solo el botón "Resumen del proceso" está habilitado; las vistas previas
// de Anexo 2/3 siguen removidas (ver RequisitosPanel.tsx).
test.describe("Alertas del proceso y resumen del proceso", () => {
